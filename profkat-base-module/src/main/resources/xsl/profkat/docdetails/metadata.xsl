                ...
                <tr>
                  <td>
                    ...
                    <xsl:if test="$pnd !='xxx'">
                      ...
                      <div class="profkat-beacon-result" title="http://d-nb.info/gnd/{$pnd}"
                           data-profkat-beacon-whitelist='["ubr_biblgr", "bibaug", "dta", "zbw", "ri_opac", "rektor", "repfont_aut", "gvk", "vd17", "wikisource", "kalliope", "ecodices", "gw", "latlib", "pw_arxiv", "pw_imslp", "pw_mvbib", "pw_perlentaucher", "slub", "hvv_lz", "hvv_zh", "notendatenbank", "commons", "cpdl", "kreusch", "rulib", "liberley", "pgde", "sophie", "wortblume", "zeno", "oenlv", "vd16", "zdn", "lbbw", "elk-wue", "fmfa"]'
